  ...
  return (
    <footer className={rootClassName}>
      <Container>
            ...
            <div className="col-span-1 lg:col-span-2">
              ...
              >
                <Image
                  ...
                  height="64"
                />
                <span className="pl-4">babydaal.co</span>
              </Link>
            </div>
        ...
        <div className="pt-6 pb-10 flex flex-col justify-between items-center space-y-4 text-accent-6 text-sm">
          <div>
            <span>&copy; 2023 babydaal. All rights reserved.</span>
          </div>
        </div>
      </Container>
    </footer>
